 ...
 return <main className="study">
  ...
  <div className="workspace">
   <section className="stage" aria-label="Map of observed aircraft over Europe">
    ...
    <div className="map-caption"><div className="clock">{stamp(ui.time)}<small> UTC</small></div><div className="count">{mode==='density'?'Full study window · hourly observations':airport?`${ui.inbound} inbound · ${ui.outbound} outbound`:`${ui.total.toLocaleString()} aircraft in the study window`}</div>{airport&&mode==='motion'&&<div className="airport-key"><span>● Inbound</span><span>● Outbound</span></div>}</div>
